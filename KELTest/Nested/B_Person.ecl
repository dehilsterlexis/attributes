...
IMPORT KEL09 AS KEL;
IMPORT E_Person FROM KELTest.Nested;
...
EXPORT B_Person := MODULE
  ...
  EXPORT IDX_Person_UID := INDEX(IDX_Person_UID_Projected,{UID},{IDX_Person_UID_Projected},'~key::KEL::KELTest::Nested::Person::UID');
